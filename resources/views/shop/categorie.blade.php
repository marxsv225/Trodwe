                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="{{asset('images/shop/'.$produit->photo)}}">
                                    <div class="label new">New</div>
                                    <ul class="product__hover">
                                        <li><a href="{{asset('images/shop/'.$produit->photo)}}" class="image-popup"><span class="arrow_expand"></span></a></li>
